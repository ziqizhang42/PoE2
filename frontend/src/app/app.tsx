...
import { AnalysisPage, GamePage, LobbyPage, PlayerPage, ReplayPage } from "./lazy-routes.ts";
import {
  ANALYSIS_PATH,
  GAME_ROUTE,
  HOME_PATH,
...
/** Keep the landing and sign-in routes eager; defer the larger application screens. */
export function App() {
  return (
    <Routes>
